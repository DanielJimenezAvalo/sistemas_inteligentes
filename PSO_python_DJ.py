...
class Particula:
    ...
    def __repr__(self):
        ...
        texto = "Partícula" \
                ...
                + "\n" \
                + "Mejor posición: " + str(self.mejor_posicion) \
                + "\n" \
...
class Enjambre:
    ...
    ----------
    particulas : `list`
        lista con todas las partÃ­culas del enjambre.
    ...
    def optimizar(self, funcion_objetivo, optimizacion, n_iteraciones = 50,
        ...
        for i in np.arange(n_iteraciones):
            ...
            if parada_temprana and i > rondas_parada:
                ...
                if all(ultimos_n < tolerancia_parada):
                    print("Algoritmo detenido en la iteración " 
                          + str(i) \
        ...
        print("NÃºmero de iteraciones: " + str(self.iter_optimizacion))
